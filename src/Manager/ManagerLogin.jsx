      ...
      .then((res) => {
        ...
        if (res.data.access && res.data.refresh) {
          Swal.fire({
            ...
            icon: 'success',
            timer: 1000,               // Set timer for 1.5 seconds
  ...
  return (
    <div className="login-container-m">
      <div className="login-box-m">
        <h2 className="login-title-m">Manager Login</h2>
        <form className="login-form-m" onSubmit={handleSubmit}>
          {/* Email Input */}
          ...
          <button
            type="submit"
            className="login-submit-button-m"
