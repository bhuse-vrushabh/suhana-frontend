                ...
                <div className="main-wrapper_n">
                    ...
                    <div>
                        <section id="assign">
                            ...
                            <form className="goal-form" onSubmit={handleAssignProgram}>
                                ...
                                <div className="tranining-button-container">
                        ...
                        <section id="assigned-training">
                            ...
                            {assignments.length > 0 ? (
                                <table className="assigned-programs-table">
                                    <thead>
                                        <tr>
                                            <th>Employee Name</th>
                                            <th>Program Name</th>
                                        ...
                                        {assignments.map((assignment, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="action-buttons">
                                                    <button onClick={() => handleEditAssignment(index)} className="edit-button">
                                                        <FontAwesomeIcon icon={faEdit} />
                                                    </button>
                                                    <button onClick={() => handleDeleteAssignment(index)} className="delete-button">
